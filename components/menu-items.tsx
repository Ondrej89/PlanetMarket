...
const components: { title: string; href: string; description: string }[] = [
  {
    title: "Tim's Terrific Toys",
    href: "http://localhost:3000/products?seller=tims-toys",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod lorem ipsum dolor sit amet.",
  },
  {
    title: "Handcraft Land",
    href: "http://localhost:3000/products?seller=handcraft-land",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod lorem ipsum dolor sit amet.",
  },
  {
    title: "Gardening Heaven",
    href: "http://localhost:3000/products?seller=gardening-heaven",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod lorem ipsum dolor sit amet.",
  },
  {
